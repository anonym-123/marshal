...
public class Main {
	...
	public static void test_marshal() throws InvalidKeyException, InvalidKeyIdException, SignatureException {
	...
	public static void test_signal()
	...
	public static void main(String[] args) throws InvalidKeyException, InvalidKeyIdException, SignatureException,
		...
		System.out.println("Run " + (int)nb_run + " tests");
